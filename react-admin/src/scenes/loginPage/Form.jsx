...
function Form({ togglePageType }) {
  ...
  const login = async (values, onSubmitProps) => {
    ...
    if (data && (data.role === 'admin' || data.role === 'manager')) {
      ...
      // Handle unauthorized access if the user is neither an admin nor a manager
      // This could be redirecting to a 'not authorized' page or showing an error message
